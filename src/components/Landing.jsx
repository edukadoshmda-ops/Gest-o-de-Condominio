        ...
        <div className="min-h-screen bg-slate-50 text-slate-900">
            ...
            <section className="pt-32 pb-20 px-4 bg-gradient-to-b from-sky-600/5 to-transparent">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <button
                        onClick={onEnter}
                        className="inline-flex items-center gap-2 px-10 py-4 rounded-2xl bg-sky-600 text-white font-black text-base shadow-xl shadow-sky-600/30 hover:scale-105 hover:bg-sky-700 transition"
                    >
            ...
            <section className="py-16 px-4 bg-white">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="bg-slate-100 rounded-3xl p-12 border border-slate-200 flex flex-col items-center justify-center min-h-[240px]">
                        <img src="/logo.png" alt="Gestor360" className="h-20 md:h-24 mb-4 object-contain" />
                        <p className="text-slate-500 font-medium mb-6">Mural, Chat, Encomendas, Reservas, Financeiro e muito mais</p>
                        <button
                            onClick={onEnter}
