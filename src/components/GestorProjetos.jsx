...
export const GestorProjetos = () => {
    useEffect(() => {
        document.title = "Gestor de projetos simples e gratuito";

        let metaDescription = document.querySelector('meta[name="description"]');
        if (metaDescription) {
            metaDescription.setAttribute("content", "Ferramenta gratuita para gerenciar projetos e tarefas online.");
        } else {
            metaDescription = document.createElement('meta');
            metaDescription.name = "description";
            metaDescription.content = "Ferramenta gratuita para gerenciar projetos e tarefas online.";
        ...
        <main className="min-h-screen bg-slate-50 flex items-center justify-center p-6 text-slate-800 font-sans">
            <div className="max-w-2xl bg-white p-10 md:p-14 rounded-[2rem] shadow-2xl shadow-slate-200/50 border border-slate-100 text-center space-y-8 relative overflow-hidden">
                ...
                <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight leading-tight">
                    Gestor de projetos online
                </h1>

                <p className="text-lg md:text-xl text-slate-500 leading-relaxed max-w-xl mx-auto font-medium">
                    Gerenciar projetos pode ser difícil quando existem muitas tarefas e prazos. Ferramentas de gestão ajudam a manter tudo organizado.
                </p>

                <p className="text-lg md:text-xl text-slate-500 leading-relaxed max-w-xl mx-auto font-medium">
                    O Gestor 360 One é um aplicativo gratuito para gerenciar projetos e organizar tarefas online.
                </p>
